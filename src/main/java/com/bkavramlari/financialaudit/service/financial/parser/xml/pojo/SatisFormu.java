...
public class SatisFormu implements Serializable {
    ...
    public static class Ozel implements Serializable {
        @XmlElement(name = "toplamSatisBedeli")
        private String toplamSatisBedeli;
        @XmlElement
        private SatisBildirimi satisBildirimi;
    }
    ...
    @Data
    @ToString
    @XmlRootElement(name = "satisBildirimi")
    @XmlAccessorType(XmlAccessType.FIELD)
    public static class SatisBildirimi implements Serializable {
        @XmlElement
        private List<BS> bs;
    }
